...
mod tests {
    ...
    use ethers::{prelude::{MockProvider, Provider}, providers::Http};
    ...
    async fn handle_tx_v06_ok() {
        ...
        let tx_hash =
            H256::from_str("0xf9f60f6dc99663c6ce4912ef92fe6a122bb90585e47b5f213efca1705be26d6e")
                .unwrap();
        let tx: Transaction = serde_json::from_str(r#"
        {
            "accessList": [],
            "blockHash": "0xe90aa1d6038c87b029a0666148ac2058ab8397f9c53594cc5a38c0113a48eab4",
            "blockNumber": "0x11e7bd0",
            "chainId": "0x1",
            "from": "0x2df993cd76bb8dbda50546eef00eee2e6331a2c8",
            "gas": "0x64633",
            "gasPrice": "0x8b539dcf3",
            "hash": "0xf9f60f6dc99663c6ce4912ef92fe6a122bb90585e47b5f213efca1705be26d6e",
            ...
            "maxFeePerGas": "0xc88385240",
            "maxPriorityFeePerGas": "0x1dcd6500",
            "nonce": "0x143",
            "r": "0x1c2b5eb48f71d803de3557309428decfa63f639a97ab98ab6b52667b9c415aa0",
            "s": "0x54a110c5f7db8ce7a488080249d3eab77e426300cd36b78cf82156ded86b26ee",
        ...
        "#).unwrap();
        let receipt: TransactionReceipt = serde_json::from_str(r#"
        {
            "blockHash": "0xe90aa1d6038c87b029a0666148ac2058ab8397f9c53594cc5a38c0113a48eab4",
            "blockNumber": "0x11e7bd0",
            "contractAddress": null,
            "cumulativeGasUsed": "0xca9e14",
            "effectiveGasPrice": "0x8b539dcf3",
            "from": "0x2df993cd76bb8dbda50546eef00eee2e6331a2c8",
            "gasUsed": "0x27a21",
            "logs": [
                {
                    ...
                    "blockHash": "0xe90aa1d6038c87b029a0666148ac2058ab8397f9c53594cc5a38c0113a48eab4",
                    "blockNumber": "0x11e7bd0",
                    "data": "0x000000000000000000000000000000000000000000000000002bea15dbb76400",
                    "logIndex": "0x10a",
                    "removed": false,
                    "topics": [
                        "0x2da466a7b24304f47e87fa2e1e5a81b9831ce54fec19055ce277ca2f39ba42c4",
                        "0x000000000000000000000000eae4d85f7733ad522f601ce7ad4f595704a2d677"
                    ],
                    "transactionHash": "0xf9f60f6dc99663c6ce4912ef92fe6a122bb90585e47b5f213efca1705be26d6e",
                    "transactionIndex": "0x63"
                },
                {
                    "address": "0x5ff137d4b0fdcd49dca30c7cf57e578a026d2789",
                ...
                },
                {
                    ...
                    "blockHash": "0xe90aa1d6038c87b029a0666148ac2058ab8397f9c53594cc5a38c0113a48eab4",
                    "blockNumber": "0x11e7bd0",
                    "data": "",
                    "logIndex": "0x10d",
                    "removed": false,
                    "topics": [
            ...
            "logsBloom": "",
            "status": "0x1",
            "to": "0x5ff137d4b0fdcd49dca30c7cf57e578a026d2789",
            "transactionHash": "0xf9f60f6dc99663c6ce4912ef92fe6a122bb90585e47b5f213efca1705be26d6e",
            "transactionIndex": "0x63",
    ...
    #[tokio::test]
    async fn handle_zion_tx_v06_ok() {
        dotenv().ok();

        let db = get_shared_db().await;
        let client = Http::from_str("https://devnet-rpc.zionx.network").unwrap();

        // just some random tx from mainnet
        let tx_hash =
            H256::from_str("0x35efb85fae1bde4a9ee0d6c1f6bff3e6ee7045283a5bdfcf4ea48d587cc6d626")
                .unwrap();

        let indexer = Indexer::new(
            Provider::new(CommonTransport::Http(client)),
            db.clone(),
            Default::default(),
        );
        indexer.handle_tx::<v06::IndexerV06>(tx_hash).await.unwrap();
        ...
        let op_hash =
            H256::from_str("0xa751f2bc300719b978b7db5183100c1fd6aab52ef2aa29308dbc55ca73439265")
                .unwrap();
        let user_op = repository::user_op::find_user_op_by_op_hash(&db, op_hash)
            .await
            .unwrap()
        ...
        println!("{user_op:#?}");
        assert_eq!(user_op.sender, "0xceb4058d4ae49a094cc8292a4eb312ef65974f2f".parse::<Address>().unwrap());
    }
    ...
    async fn handle_tx_v07_ok() {
        ...
        assert_eq!(user_op, UserOp {
            ...
            aggregator: None,
            aggregator_signature: None,
            entry_point: v07::IndexerV07::entry_point(),
